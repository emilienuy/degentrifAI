...
//     let gentrifiable = feature.properties?.gentrifiable;
//     const gentrification_level = feature.properties?.gentrification_level;
//     const tract = feature.properties?.tract || "Unknown";

//     gentrified = gentrified === 1 ? "gentrified" : "not gentrified";
//     gentrifiable = gentrifiable === 1 ? "gentrifiable" : "not gentrifiable";

//     const popupContent = `
//       <div>
//         <p>This neighbourhood (tract ${tract}) was ${gentrified} in ${year} with a level of ${gentrification_level}.</p>
//         <p>It is also deemed ${gentrifiable}, meaning that it has the characteristics that may lead to gentrification.</p>
//       </div>
//     `;
