  ...
  const steps = [
    ...
    )},
    {
      ...
      description: [
        ...
        "Census Data Overview: Census data encompasses a wide range of statistical insights about the population, including demographics such as age, sex at birth, and gender identity, as well as details about dwelling types, familial structures, marital statuses, military service, income distribution, linguistic diversity, Indigenous communities, housing conditions, immigration patterns, citizenship status, ethnic and religious demographics, mobility trends, educational attainment, employment statistics, and commuting behaviors. These metrics are systematically collected through the Census Program[14].",
        "Level of Analysis: Census Tracts DegentrifAI focuses its analysis on the Montreal Census Metropolitan Area (CMA) and utilizes Census tracts as the primary unit of examination. A Census Metropolitan Area, or CMA, comprises one or more adjacent municipalities with a collective population exceeding 100,000, with at least 50,000 residents residing in the core area[15]. Census tracts are relatively small and consistent geographical zones, typically accommodating populations ranging from 2,500 to 8,000 individuals[16]. Their delineations are established through collaboration between local stakeholders and Statistics Canada, ensuring alignment with enduring physical features and, whenever possible, conforming to established neighborhood boundaries[16].",
        "Gentrification measures: Drawing on Canadian census data, the authors evaluated various gentrification metrics to determine their efficacy in capturing observed gentrification patterns in Canadian urban centers. Our team met with the authors to discuss the census data sets and gentrification measures that we should use. After consultation, we decided to use the Ding measure, as it most accurately captures observed gentrification in Canadian cities [12]. After consulting the GENUINE team, who Ding measures: Gentrifiable, Gentrified, Gentrification Level."
      ],
      icon: <StorageIcon />
    },
