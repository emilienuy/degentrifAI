...
const Team = () => {
  return (
    ...
    <div class="team-container">
        ...
        <img src={`${process.env.PUBLIC_URL}/pictures/Emily_Hong.JPG`} alt="Team Member 1" class="member-photo" />
        ...
        <div class="team-member">
            <img src="/pictures/Theresa_Quan.JPG" alt="Member 2" class="member-photo" /> 
            <div class="member-info">
                <h2>Yutong(Theresa) Quan</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam.</p>
            </div>
        </div>
        <div class="team-member">
            <img src="/pictures/Emilie.jpg" alt="Member 3" class="member-photo" />
            <div class="member-info">
                <h2>Emilie Nuyttens</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec odio. Praesent libero. Sed cursus ante dapibus diam.</p>
            </div>
        </div>
        <div class="team-member">
